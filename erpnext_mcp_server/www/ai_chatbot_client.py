...
def get_context(context):
    ...
    frappe.local.response["location"] = "/ai-chatbot-client"
    ...
    context["icon_32"] = (
        favicon or "/assets/erpnext_mcp_server/manifest/favicon-96x96.png"
    )
    context["icon_16"] = (
        favicon or "/assets/erpnext_mcp_server/manifest/favicon-96x96.png"
    )
    context["apple_touch_icon"] = (
        favicon or "/assets/erpnext_mcp_server/manifest/apple-touch-icon.png"
    )
    context["mask_icon"] = favicon or "/assets/erpnext_mcp_server/manifest/favicon.svg"
