  ...
  var ChatMCPClient = class {
    ...
    async startMCPServer() {
      ...
      try {
        ...
        if (response2.message && response2.message.status === "success") {
          await new Promise((resolve) => setTimeout(resolve, 2e3));
          await this.initMCPStatus();
          return { success: this.mcpServerRunning };
        }
        return { success: false, message: ((_a = response2.message) == null ? void 0 : _a.message) || "Failed to start MCP server" };
      } catch (error) {
    ...
    async stopMCPServer() {
      ...
      try {
        ...
        return { success: false, message: ((_a = response2.message) == null ? void 0 : _a.message) || "Failed to stop MCP server" };
      } catch (error) {
    ...
    async queryMCP(query, context = {}) {
      ...
      try {
        ...
        return response2.message || { error: "No response from MCP server" };
      } catch (error) {
...
//# sourceMappingURL=erpnext_mcp_server.bundle.2KKHJ4TW.js.map
