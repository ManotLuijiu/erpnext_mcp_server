...
import { Check, Magnet, Waves, X } from 'lucide-react';
  ...
  return (
    ...
    <div className="relative z-10">
      ...
      >
        {value}
        <span>
          <X className="ml-2 text-sm" />
        </span>
      </Button>
      <div className={selectedItem ? 'hidden' : ''}>
        <Magnet className="absolute left-2.5 top-1.5 text-xs text-neutral-50" />
        <input
      ...
      <div
        className={clsx(
          'mt-1 max-h-40 w-full min-w-56 overflow-y-auto rounded bg-neutral-600 p-2',
          {
            hidden: !isOpen,
          }
        )}
